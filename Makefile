...
PREPROC = 'arm-none-eabi-cpp' '-E' '-P' '-Wl,--gc-sections' '-Wl,--wrap,main' '-Wl,--wrap,_malloc_r' '-Wl,--wrap,exit' '-Wl,--wrap,atexit' '-mcpu=cortex-m3' '-mthumb'
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1494028118.23
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1494028118.23
